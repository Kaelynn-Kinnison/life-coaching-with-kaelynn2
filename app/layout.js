          ...
          <nav className="max-w-6xl mx-auto px-4 sm:px-6 py-4">
            <div className="flex items-center justify-center sm:justify-between gap-3">
              <Link href="/" className="flex items-center gap-3">
                ...
                />
                <span className="font-semibold text-[#2f2a35] text-sm sm:text-base">
                  Life Coaching with Kaelynn
                </span>
              </Link>

              <div className="hidden md:flex items-center gap-5 text-sm font-medium text-[#2f2a35]">
            ...
            <div className="md:hidden mt-4 grid grid-cols-2 gap-2 text-center text-sm font-medium text-[#2f2a35]">
              ...
              <Link className="rounded-full bg-[#2f2a35] text-white px-3 py-2 col-span-2" href="/contact">
